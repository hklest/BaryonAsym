...
main(int argc, char* argv[])
{
    ...
    while (H1Tree::Instance()->Next() && !opts.IsMaxEvent(eventCounter)) {
        ...
        if (ProtonPSTrack->GetDedxLikelihood(H1Dedx::kProton) > 0.002) {
        ...
        if (ProtonPSTrack->GetDedxLikelihood(H1Dedx::kProton) > 0.004) {
            hLambdaPIDprotontest4->Fill(invMasslambda);
        }
        if (ProtonPSTrack->GetDedxLikelihood(H1Dedx::kProton) > 0.005) {
            hLambdaPIDprotontest5->Fill(invMasslambda);
        }
        if (ProtonPSTrack->GetDedxLikelihood(H1Dedx::kProton) > 0.006) {
            hLambdaPIDprotontest6->Fill(invMasslambda);
        }
        if (ProtonPSTrack->GetDedxLikelihood(H1Dedx::kProton) > 0.007) {
            hLambdaPIDprotontest7->Fill(invMasslambda);
        }
        if (ProtonPSTrack->GetDedxLikelihood(H1Dedx::kProton) > 0.008) {
            hLambdaPIDprotontest8->Fill(invMasslambda);
        }
        if (ProtonPSTrack->GetDedxLikelihood(H1Dedx::kProton) > 0.009) {
            hLambdaPIDprotontest9->Fill(invMasslambda);
        }
        if (ProtonPSTrack->GetDedxLikelihood(H1Dedx::kProton) > 0.010) {
        ...
        if (PionPSTrack->GetDedxLikelihood(H1Dedx::kPion) > 0.002) {
        ...
        if (PionPSTrack->GetDedxLikelihood(H1Dedx::kPion) > 0.004) {
            hLambdaPIDpiontest4->Fill(invMasslambda);
        }
        if (PionPSTrack->GetDedxLikelihood(H1Dedx::kPion) > 0.005) {
            hLambdaPIDpiontest5->Fill(invMasslambda);
        }
        if (PionPSTrack->GetDedxLikelihood(H1Dedx::kPion) > 0.006) {
            hLambdaPIDpiontest6->Fill(invMasslambda);
        }
        if (PionPSTrack->GetDedxLikelihood(H1Dedx::kPion) > 0.007) {
            hLambdaPIDpiontest7->Fill(invMasslambda);
        }
        if (PionPSTrack->GetDedxLikelihood(H1Dedx::kPion) > 0.008) {
            hLambdaPIDpiontest8->Fill(invMasslambda);
        }
        if (PionPSTrack->GetDedxLikelihood(H1Dedx::kPion) > 0.009) {
            hLambdaPIDpiontest9->Fill(invMasslambda);
        }
        if (PionPSTrack->GetDedxLikelihood(H1Dedx::kPion) > 0.010) {
