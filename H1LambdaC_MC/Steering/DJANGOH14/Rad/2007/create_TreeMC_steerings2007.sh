...
line2="/data/dust/group/h1/gtustin/h1oo/H1LambdaC_MC/EventLists/DJANGOH14/2007/condor_07_evlsMC_DJANGOH14_Rad_"
line3=".root\";}"
# Specify the range of numbers for the file names

search_string="condor_07_evlsMC_DJANGOH14_Rad_"

# Specify the path to the directory containing files with the string
search_directory="/data/dust/group/h1/gtustin/h1oo/H1LambdaC_MC/EventLists/DJANGOH14/2007"
...
for ((i = $start_number; i < $end_number; i++)); do
    ...
    file_name="TreeMC_DJANGOH14_07_RAD_$i.steer"
