...
line2="/data/dust/group/h1/gtustin/h1oo/H1LambdaC_MC/EventLists/RAPGAP31/2007/condor_07_evlsMC_RAPGAP31_Rad_"
line3=".root\";}"
# Specify the range of numbers for the file names

search_string="condor_07_evlsMC_RAPGAP31_Rad_"

# Specify the path to the directory containing files with the string
search_directory="/data/dust/group/h1/gtustin/h1oo/H1LambdaC_MC/EventLists/RAPGAP31/2007"
...
for ((i = $start_number; i < $end_number; i++)); do
    ...
    file_name="TreeMC_RAPGAP31_07_RAD_$i.steer"
