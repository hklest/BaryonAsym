...
line2="/data/dust/group/h1/gtustin/h1oo/H1LambdaC_MC/EventLists/RAPGAP31/2005/condor_05_evlsMC_RAPGAP31_Rad_"
line3=".root\";}"
# Specify the range of numbers for the file names

search_string="condor_05_evlsMC_RAPGAP31_Rad_"

# Specify the path to the directory containing files with the string
search_directory="/data/dust/group/h1/gtustin/h1oo/H1LambdaC_MC/EventLists/RAPGAP31/2005"
...
for ((i = $start_number; i < $end_number; i++)); do
    ...
    file_name="TreeMC_RAPGAP31_05_RAD_$i.steer"
