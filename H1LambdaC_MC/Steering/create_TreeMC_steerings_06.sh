...
line2="/nfs/dust/h1/group/gtustin/h1oo/H1LambdaC_MC/EventLists/condor_06_evlsMC_RAPGAP06_RAD_"
line3=".root\";}"
# Specify the range of numbers for the file names

search_string="condor_06_evlsMC_RAPGAP06_RAD_"

# Specify the path to the directory containing files with the string
search_directory="/nfs/dust/h1/group/gtustin/h1oo/H1LambdaC_MC/EventLists"
...
for ((i = $start_number; i < $end_number; i++)); do
    ...
    file_name="TreeMC_RAPGAP_06_RAD_$i.steer"
