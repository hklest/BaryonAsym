...
main(int argc, char* argv[])
{
    ...
    double pT, Eta, x, invMasslambda, Q2s, Ys, Angle, v0chi2, weight1, weight2, SVx, SVy, SVz, PVx, PVy, PVz, LambdaPX, LambdaPY, LambdaPZ;
    //defining variables needed only for MC Lambdas
    double genIvxX, genIvxY, genIvxZ, decayrecX, decayrecY, decayrecZ, strIVtype;
    int fRunType;
    ...
    //Pointers to arrays to loop over
