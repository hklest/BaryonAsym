...
sed -i '35c\'"const int q2entries = 8;" "/data/dust/group/h1/gtustin/h1oo/H1LambdaC/Asym.C"
...
cp /data/dust/group/h1/gtustin/h1oo/H1LambdaC/AnalysisResultFiles/AnalysisOutput.root /data/dust/group/h1/gtustin/h1oo/H1LambdaC/AnalysisResultFiles/AsymRadDecayVtx_All.root 							
