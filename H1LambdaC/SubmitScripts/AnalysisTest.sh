...
#Before calling root macro, need to write command to edit line defining num of bin entries
#C++ will not let this be a variable input since it defines array lengths
sed -i '35c\'"const int q2entries = 12;" "/data/dust/group/h1/klesthen/BaryonAsym/H1LambdaC/Analysis2.C"
root -l -q '/data/dust/group/h1/klesthen/BaryonAsym/H1LambdaC/Analysis2.C(
6,
