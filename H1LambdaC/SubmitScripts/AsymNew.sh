...
sed -i '35c\'"const int q2entries = 9;" "/data/dust/group/h1/gtustin/h1oo/H1LambdaC/Asym_3_6_25.C"
root -l -q '/data/dust/group/h1/gtustin/h1oo/H1LambdaC/Asym_3_6_25.C(
2,
