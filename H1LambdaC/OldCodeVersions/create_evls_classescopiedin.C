...
H1FloatPtr RunType("RunType"); //Q2 variable aquired using sigma method
//ClassImp(elecCut) 
...
main(int argc, char* argv[])
{
    ...
    double elecPhi, elecTheta, Epz, elecE, x, Q2s, Ys, RTheta, ClusterRadius, Zvertex, ProtonEnergy, ElectronEnergy, Xcluster, Ycluster, Zcluster, RunNumber, RunLumi;
