...
//MC
string fileEventTree = "/nfs/dust/h1/group/gtustin/h1oo/H1LambdaC_MC/genMCTree_DJANGOH14NONRAD/merged.root";

string outputfilename = "/nfs/dust/h1/group/gtustin/h1oo/H1LambdaC/check.root";
