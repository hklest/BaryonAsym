...
string outputfilename = "/data/dust/group/h1/gtustin/h1oo/H1LambdaC/AsymControlPlot.root";
...
void AsymControlPlot() {
	...
	//Plot("/data/dust/group/h1/gtustin/h1oo/H1LambdaC/AnalysisResultFiles/AnalysisRadDecay_All_MCZ.root", "/data/dust/group/h1/gtustin/h1oo/H1LambdaC/AnalysisResultFiles/AnalysisRadDecay_All_DataZ.root", "/data/dust/group/h1/gtustin/h1oo/H1LambdaC/AnalysisResultFiles/AnalysisEta_2007.root", "/data/dust/group/h1/gtustin/h1oo/H1LambdaC/AnalysisResultFiles/AnalysisEta_All.root", outputfile, "Asym vs #Lambda Z Decay Vertex", "(N_{#Lambda} - N_{#bar{#Lambda}})/(N_{#Lambda} + N_{#bar{#Lambda}})", "Z Decay Vertex [cm]", "A_{#Lambda}", "Lambda Asymm vs q2 TGraph");
	//Plot("/data/dust/group/h1/gtustin/h1oo/H1LambdaC/AnalysisResultFiles/AnalysisRadDecay_All_MCR.root", "/data/dust/group/h1/gtustin/h1oo/H1LambdaC/AnalysisResultFiles/AnalysisRadDecay_All.root", "/data/dust/group/h1/gtustin/h1oo/H1LambdaC/AnalysisResultFiles/AnalysisEta_2007.root", "/data/dust/group/h1/gtustin/h1oo/H1LambdaC/AnalysisResultFiles/AnalysisEta_All.root", outputfile, "Asym vs #Lambda R Decay Vertex", "(N_{#Lambda} - N_{#bar{#Lambda}})/(N_{#Lambda} + N_{#bar{#Lambda}})", "R Decay Vertex [cm]", "A_{#Lambda}", "Lambda Asymm vs q2 TGraph");
	//Plot("/data/dust/group/h1/gtustin/h1oo/H1LambdaC/AnalysisResultFiles/AnalysisZDecay_GenLvl.root", "/data/dust/group/h1/gtustin/h1oo/H1LambdaC/AnalysisResultFiles/AnalysisRadDecay_All_MCZ.root", "/data/dust/group/h1/gtustin/h1oo/H1LambdaC/AnalysisResultFiles/AnalysisEta_2007.root", "/data/dust/group/h1/gtustin/h1oo/H1LambdaC/AnalysisResultFiles/AnalysisEta_All.root", outputfile, "Asym vs #Lambda Z Decay Vertex", "(N_{#Lambda} - N_{#bar{#Lambda}})/(N_{#Lambda} + N_{#bar{#Lambda}})", "Z Decay Vertex [cm]", "A_{#Lambda}", "Lambda Asymm vs q2 TGraph");
