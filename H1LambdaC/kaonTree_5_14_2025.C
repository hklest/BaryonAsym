...
main(int argc, char* argv[])
{
   ...
   //Hardcode Test
    ...
    double scatEenergy, scatEtheta, scatEphi;
    ...
    K0Tree->Branch("PosPionL", &PosPionL, "PosPionL/D");
    K0Tree->Branch("NegPionL", &NegPionL, "NegPionL/D");
    ...
    K0StrTree->Branch("PosPionL", &PosPionL, "PosPionL/D");
    K0StrTree->Branch("NegPionL", &NegPionL, "NegPionL/D");
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
       ...
       /* if (particlesinevent > 1) {
        ...
        //For some reason events with no detected scattered electron are making it into here
        if (*ElecE==0) {
            breakloopcount++;
            continue;
        }
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        PosPionL = PosPionPSTrack->GetDedxLikelihood(H1Dedx::kPion);
        NegPionL = NegPionPSTrack->GetDedxLikelihood(H1Dedx::kPion);
...
//         The candidate with measured pT closest to generated pT is assumed to be the correct one
        ...
        if (fRunType != 0) {
            ...
            if (GtrK0Index.size() != 0) {
                for (Int_t k = 0; k < GtrK0Index.size(); k++) {
                    H1PartMC* part = gtrdata[GtrK0Index[k]];
