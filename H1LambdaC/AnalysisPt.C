...
const int variableentries = pTentries;
vector<double> bins = { 0.5, 0.6, 0.7, 0.8, 0.9, 1.1, 1.3, 1.6, 2.2, 3.5 };
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// DATA
//string filekaonTree = "/data/dust/group/h1/klesthen/BaryonAsym/H1LambdaC/KaonTree/2006/merged.root";
string filekaonTree = "/data/dust/group/h1/klesthen/BaryonAsym/H1LambdaC/KaonTree/merged.root";

//string filelambdaTree = "/data/dust/group/h1/klesthen/BaryonAsym/H1LambdaC/LambdaTree/2006/merged.root";
string filelambdaTree = "/data/dust/group/h1/klesthen/BaryonAsym/H1LambdaC/LambdaTree/merged.root";
//END DATA
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//MC
//string filekaonTreeMC = "/data/dust/group/h1/klesthen/BaryonAsym/H1LambdaC_MC/KaonTreeMC/RAPGAP31/2006/merged.root";
string filekaonTreeMC = "/data/dust/group/h1/klesthen/BaryonAsym/H1LambdaC_MC/KaonTreeMC/RAPGAP31/merged.root";


//string filelambdaTreeMC = "/data/dust/group/h1/klesthen/BaryonAsym/H1LambdaC_MC/LambdaTreeMC/RAPGAP31/2006/merged.root";
string filelambdaTreeMC = "/data/dust/group/h1/klesthen/BaryonAsym/H1LambdaC_MC/LambdaTreeMC/RAPGAP31/merged.root";


//string filegenMCTree = "/data/dust/group/h1/klesthen/BaryonAsym/H1LambdaC_MC/genMCTree/RAPGAP31/Rad/2006/merged.root"; //rad RAPGAP
string filegenMCTree = "/data/dust/group/h1/klesthen/BaryonAsym/H1LambdaC_MC/genMCTree/RAPGAP31/Rad/merged.root"; //rad RAPGAP



//string fileNonRadgenMCTree = "/data/dust/group/h1/klesthen/BaryonAsym/H1LambdaC_MC/genMCTree/DJANGOH14/NonRad/2006/merged.root"; //non rad DJANGOH
//string fileRadgenMCTree = "/data/dust/group/h1/klesthen/BaryonAsym/H1LambdaC_MC/genMCTree/DJANGOH14/Rad/2006/merged.root";
...
//output files
string outputfilename = "/data/dust/group/h1/klesthen/BaryonAsym/H1LambdaC/AnalysisPt_All.root";
...
void AnalysisPt() {
	...
	LambdaTotDataCount = AnalyzeTree(new TFile(filelambdaTree.c_str(), "read"), "Lambda Tot", variableentries, 0, LambdaTotData, bins, "Lambda Tot Data pT Extraction ", c3, c1);
	LambdaTotMCCount = AnalyzeTree(new TFile(filelambdaTreeMC.c_str(), "read"), "Lambda Tot", variableentries, 0, LambdaTotMC, bins, "Lambda Tot MC pT Extraction ", c3, c1);

	LambdaRegDataCount = AnalyzeTree(new TFile(filelambdaTree.c_str(), "read"), "Lambda Reg", variableentries, 0, LambdaRegData, bins, "Lambda Reg Data pT Extraction ", c3, c1);
	LambdaRegMCCount = AnalyzeTree(new TFile(filelambdaTreeMC.c_str(), "read"), "Lambda Reg", variableentries, 0, LambdaRegMC, bins, "Lambda Reg MC pT Extraction ", c3, c1);

	LambdaBarDataCount = AnalyzeTree(new TFile(filelambdaTree.c_str(), "read"), "Lambda Bar", variableentries, 0, LambdaBarData, bins, "Lambda Bar Data pT Extraction ", c3, c1);
	LambdaBarMCCount = AnalyzeTree(new TFile(filelambdaTreeMC.c_str(), "read"), "Lambda Bar", variableentries, 0, LambdaBarMC, bins, "Lambda Bar MC pT Extraction ", c3, c1);

	KaonDataCount = AnalyzeTree(new TFile(filekaonTree.c_str(), "read"), "K0", variableentries, 1, KaonData, bins, "Kaon Tot Data pT Extraction ", c3, c1);
	KaonMCCount = AnalyzeTree(new TFile(filekaonTreeMC.c_str(), "read"), "K0", variableentries, 1, KaonMC, bins, "Kaon Tot MC pT Extraction ", c3, c1);
	...
	double xerr[variableentries] = { 0.05, 0.05, 0.05, 0.05, 0.1, 0.1, 0.15, 0.3, 0.65 };
	double xvals[variableentries] = { 0.55, 0.65, 0.75, 0.85, 1.0, 1.2, 1.45, 1.9, 2.85 };
	...
	double dyup[9];
	int n = 0;
	X[n] = xvals[n];	y[n] = 8.4;	dxlow[n] = 0;	dxup[n] = 0;	dylow[n] = 0.4;	dyup[n] = 0.4;	n++;
	X[n] = xvals[n];	y[n] = 8.0;	dxlow[n] = 0;	dxup[n] = 0;	dylow[n] = 0.25;	dyup[n] = 0.25;	n++;
	X[n] = xvals[n];	y[n] = 7.9;	dxlow[n] = 0;	dxup[n] = 0;	dylow[n] = 0.25;	dyup[n] = 0.25;	n++;
	X[n] = xvals[n];	y[n] = 6.8;	dxlow[n] = 0;	dxup[n] = 0;	dylow[n] = 0.15;	dyup[n] = 0.15;	n++;
	X[n] = xvals[n];	y[n] = 6.1;	dxlow[n] = 0;	dxup[n] = 0;	dylow[n] = 0.1;	dyup[n] = 0.1;	n++;
	X[n] = xvals[n];	y[n] = 4.70;	dxlow[n] = 0;	dxup[n] = 0;	dylow[n] = 0.09;	dyup[n] = 0.09;	n++;
	X[n] = xvals[n];	y[n] = 3.05;	dxlow[n] = 0;	dxup[n] = 0;	dylow[n] = 0.05;	dyup[n] = 0.05;	n++;
	X[n] = xvals[n];	y[n] = 1.52;	dxlow[n] = 0;	dxup[n] = 0;	dylow[n] = 0.025;	dyup[n] = 0.025;	n++;
	X[n] = xvals[n];	y[n] = 0.42;	dxlow[n] = 0;	dxup[n] = 0;	dylow[n] = 0.01;	dyup[n] = 0.01;	n++;
	//
	...
	for (int k = 0; k < variableentries; k++) {
		...
		cout << "Lambda Rad Cor pT Bin " << k + 1 << ": " << templambdaradcorr << endl;
	...
	dylow2[m] = 0.5;	dyup2[m] = 0.4;	m++;
	dylow2[m] = 0.5;	dyup2[m] = 0.5;	m++;
	dylow2[m] = 0.5;	dyup2[m] = 0.5;	m++;
	dylow2[m] = 0.4;	dyup2[m] = 0.4;	m++;
	dylow2[m] = 0.30;	dyup2[m] = 0.29;	m++;
	...
	ceff->SetName("Lambda Reconstruction Eff vs pT");
	...
	effreg->SetTitle("#Lambda Reconstruction Eff vs pT");
	effreg->GetXaxis()->SetTitle("pT");
	...
	PlotData("Lambda Cross Section vs pT", "d#sigma(ep #rightarrow e [#Lambda + #bar{#Lambda}] X)/dx", "pT", "d#sigma/dx",0,4.2, cs, variableentries, X, y, xerr, y1err, dylow, dyup, dylow2, dyup2);
	for (int k = 0; k < variableentries; k++) {
		cout << "Lambda pT Cross Section Entry " << k + 1 << " : " << y1[k] << " X: " << X[k] << "p/m: " << y1err[k] << endl;
	}
	...
	X[n] = xvals[n];	y[n] = 0.07815;	dxlow[n] = 0;	dxup[n] = 0;	dylow[n] = 0.0886;	dyup[n] = 0.0886;	n++;
	X[n] = xvals[n];	y[n] = 0.02523;	dxlow[n] = 0;	dxup[n] = 0;	dylow[n] = 0.0615;	dyup[n] = 0.0615;	n++;
	X[n] = xvals[n];	y[n] = -0.070769;	dxlow[n] = 0;	dxup[n] = 0;	dylow[n] = 0.0578;	dyup[n] = 0.0578;	n++;
	X[n] = xvals[n];	y[n] = -0.0326154;	dxlow[n] = 0;	dxup[n] = 0;	dylow[n] = 0.03815;	dyup[n] = 0.03815;	n++;
	X[n] = xvals[n];	y[n] = -0.0215385;	dxlow[n] = 0;	dxup[n] = 0;	dylow[n] = 0.03815;	dyup[n] = 0.03815;	n++;
	X[n] = xvals[n];	y[n] = -0.0350769;	dxlow[n] = 0;	dxup[n] = 0;	dylow[n] = 0.0369231;	dyup[n] = 0.0369231;	n++;
	X[n] = xvals[n];	y[n] = 0.00430769;	dxlow[n] = 0;	dxup[n] = 0;	dylow[n] = 0.0332308;	dyup[n] = 0.0332308;	n++;
	X[n] = xvals[n];	y[n] = 0.0141538;	dxlow[n] = 0;	dxup[n] = 0;	dylow[n] = 0.03938;	dyup[n] = 0.03938;	n++;
	X[n] = xvals[n];	y[n] = 0.0104615;	dxlow[n] = 0;	dxup[n] = 0;	dylow[n] = 0.04923;	dyup[n] = 0.04923;	n++;
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	PlotData("Lambda Asymm vs pT", "[#sigma(ep #rightarrow e #Lambda X) - #sigma(ep #rightarrow e #bar{#Lambda} X)] / [#sigma(ep #rightarrow e #Lambda X) + #sigma(ep #rightarrow e #bar{#Lambda} X)]", "pT", "A_{#Lambda}",-0.3,0.3, cs2, variableentries, X, y, xerr, y1err, dylow, dyup, dylow, dyup);
	
	//K0 Cross section results from 2009 H1 Paper
	n = 0;
	X[n] = xvals[n];	y[n] = 34.6;	dxlow[n] = 0;	dxup[n] = 0;	dylow[n] = 0.25;	dyup[n] = 0.25;	n++;
	X[n] = xvals[n];	y[n] = 29.6;	dxlow[n] = 0;	dxup[n] = 0;	dylow[n] = 0.2;	dyup[n] = 0.2;	n++;
	X[n] = xvals[n];	y[n] = 25.5;	dxlow[n] = 0;	dxup[n] = 0;	dylow[n] = 0.2;	dyup[n] = 0.2;	n++;
	X[n] = xvals[n];	y[n] = 20.4;	dxlow[n] = 0;	dxup[n] = 0;	dylow[n] = 0.15;	dyup[n] = 0.15;	n++;
	X[n] = xvals[n];	y[n] = 15.2;	dxlow[n] = 0;	dxup[n] = 0;	dylow[n] = 0.1;	dyup[n] = 0.1;	n++;
	X[n] = xvals[n];	y[n] = 10.46;	dxlow[n] = 0;	dxup[n] = 0;	dylow[n] = 0.07;	dyup[n] = 0.07;	n++;
	X[n] = xvals[n];	y[n] = 6.91;	dxlow[n] = 0;	dxup[n] = 0;	dylow[n] = 0.05;	dyup[n] = 0.05;	n++;
	X[n] = xvals[n];	y[n] = 3.13;	dxlow[n] = 0;	dxup[n] = 0;	dylow[n] = 0.02;	dyup[n] = 0.02;	n++;
	X[n] = xvals[n];	y[n] = 0.83;	dxlow[n] = 0;	dxup[n] = 0;	dylow[n] = 0.01;	dyup[n] = 0.01;	n++;
	//
	m = 0;
	...
	for (int k = 0; k < variableentries; k++) {
		...
		cout << "K0 Rad Cor pT Bin " << k + 1 << ": " << tempk0radcorr << endl;
	...
	ckeff->SetName("K0 Reconstruction Eff vs pT");
	...
	effreg2->SetTitle("K^{0}_{S} Reconstruction Eff vs pT");
	effreg2->GetXaxis()->SetTitle("pT");
	...
	cradcorr->SetName("Radiaitve Corrections vs pT");
	...
	radcorrlambda->SetTitle("Radiative Corrections vs pT");
	radcorrlambda->GetXaxis()->SetTitle("pT");
	radcorrlambda->GetYaxis()->SetTitle("#delta_{QED} [%]");
	radcorrk0->SetTitle("Radiative Corrections vs pT");
	radcorrk0->GetXaxis()->SetTitle("pT");
	radcorrk0->GetYaxis()->SetTitle("#delta_{QED} [%]");
	//radcorrlambda->Draw();
	radcorrk0->Draw();
	radcorrlambda->Draw("SAME");
	//effbar->Draw("SAME");
	...
	PlotData("K0 Cross Section vs pT", "d#sigma(ep #rightarrow e K^{0}_{S} X)/dx", "pT", "d#sigma/dx [nb]",0,10.5, cs3, variableentries, X, y, xerr, y1err, dylow, dyup, dylow2, dyup2);
	for (int k = 0; k < variableentries; k++) {
		cout << "K0 pT Cross Section Entry " << k + 1 << " : " << y1[k] << " X: " << X[k] << "p/m: " << y1err[k] << endl;
	}
	...
	n = 0;
	X[n] = xvals[n];	y[n] = 0.24;	dxlow[n] = 0;	dxup[n] = 0;	dylow[n] = 0.01;	dyup[n] = 0.01;	n++;
	X[n] = xvals[n];	y[n] = 0.268;	dxlow[n] = 0;	dxup[n] = 0;	dylow[n] = 0.075;	dyup[n] = 0.075;	n++;
	X[n] = xvals[n];	y[n] = 0.309;	dxlow[n] = 0;	dxup[n] = 0;	dylow[n] = 0.01;	dyup[n] = 0.01;	n++;
	X[n] = xvals[n];	y[n] = 0.334;	dxlow[n] = 0;	dxup[n] = 0;	dylow[n] = 0.07;	dyup[n] = 0.07;	n++;
	X[n] = xvals[n];	y[n] = 0.402;	dxlow[n] = 0;	dxup[n] = 0;	dylow[n] = 0.075;	dyup[n] = 0.075;	n++;
	X[n] = xvals[n];	y[n] = 0.450;	dxlow[n] = 0;	dxup[n] = 0;	dylow[n] = 0.09;	dyup[n] = 0.09;	n++;
	X[n] = xvals[n];	y[n] = 0.442;	dxlow[n] = 0;	dxup[n] = 0;	dylow[n] = 0.08;	dyup[n] = 0.08;	n++;
	X[n] = xvals[n];	y[n] = 0.485;	dxlow[n] = 0;	dxup[n] = 0;	dylow[n] = 0.08;	dyup[n] = 0.08;	n++;
	X[n] = xvals[n];	y[n] = 0.505;	dxlow[n] = 0;	dxup[n] = 0;	dylow[n] = 0.0135;	dyup[n] = 0.0135;	n++;
	...
	dylow2[m] = 0.020;	dyup2[m] = 0.019;	m++;
	...
	PlotData("Lambda/K0 Cross Section vs pT", "[d#sigma(ep #rightarrow e #Lambda X)]/[d#sigma(ep #rightarrow e K^{0}_{S} X)]", "pT", "#Lambda/K^{0}_{S}",0,0.51, cs4, variableentries, X, y, xerr, y1err, dylow, dyup, dylow2, dyup2);
	...
	LambdaTotDataCountincl = AnalyzeTree(new TFile(filelambdaTree.c_str(), "read"), "Lambda Tot", 1, 0, LambdaTotDataxincl, { bins[0],bins[variableentries] }, "Lambda Tot Incl Data pT Extraction ", c3, c1);
	LambdaTotMCCountincl = AnalyzeTree(new TFile(filelambdaTreeMC.c_str(), "read"), "Lambda Tot", 1, 0, LambdaTotMCxincl, { bins[0],bins[variableentries] }, "Lambda Tot Incl MC pT Extraction ", c3, c1);

	LambdaRegDataCountincl = AnalyzeTree(new TFile(filelambdaTree.c_str(), "read"), "Lambda Reg", 1, 0, LambdaRegDataxincl, { bins[0],bins[variableentries] }, "Lambda Reg Incl Data pT Extraction ", c3, c1);
	LambdaRegMCCountincl = AnalyzeTree(new TFile(filelambdaTreeMC.c_str(), "read"), "Lambda Reg", 1, 0, LambdaRegMCxincl, { bins[0],bins[variableentries] }, "Lambda Reg Incl MC pT Extraction ", c3, c1);

	LambdaBarDataCountincl = AnalyzeTree(new TFile(filelambdaTree.c_str(), "read"), "Lambda Bar", 1, 0, LambdaBarDataxincl, { bins[0],bins[variableentries] }, "Lambda Bar Incl Data pT Extraction ", c3, c1);
	LambdaBarMCCountincl = AnalyzeTree(new TFile(filelambdaTreeMC.c_str(), "read"), "Lambda Bar", 1, 0, LambdaBarMCxincl, { bins[0],bins[variableentries] }, "Lambda Bar Incl MC pT Extraction ", c3, c1);

	KaonDataCountincl = AnalyzeTree(new TFile(filekaonTree.c_str(), "read"), "K0", 1, 1, KaonDataxincl, { bins[0],bins[variableentries] }, "Kaon Incl Data pT Extraction ", c3, c1);
	KaonMCCountincl = AnalyzeTree(new TFile(filekaonTreeMC.c_str(), "read"), "K0", 1, 1, KaonMCxincl, { bins[0],bins[variableentries] }, "Kaon Incl MC pT Extraction ", c3, c1);

	
	//LambdaTotDataCountincl = AnalyzeTree(new TFile(filelambdaTree.c_str(), "read"), "Lambda Tot", 1, 0, LambdaTotDataxincl, { 10,bins[variableentries] }, "Lambda Tot Incl Data pT Extraction ", c3, c1);
	//LambdaTotMCCountincl = AnalyzeTree(new TFile(filelambdaTreeMC.c_str(), "read"), "Lambda Tot", 1, 0, LambdaTotMCxincl, { 10,bins[variableentries] }, "Lambda Tot Incl MC pT Extraction ", c3, c1);

	//LambdaRegDataCountincl = AnalyzeTree(new TFile(filelambdaTree.c_str(), "read"), "Lambda Reg", 1, 0, LambdaRegDataxincl, { 10,bins[variableentries] }, "Lambda Reg Incl Data pT Extraction ", c3, c1);
	//LambdaRegMCCountincl = AnalyzeTree(new TFile(filelambdaTreeMC.c_str(), "read"), "Lambda Reg", 1, 0, LambdaRegMCxincl, { 10,bins[variableentries] }, "Lambda Reg Incl MC pT Extraction ", c3, c1);

	//LambdaBarDataCountincl = AnalyzeTree(new TFile(filelambdaTree.c_str(), "read"), "Lambda Bar", 1, 0, LambdaBarDataxincl, { 10,bins[variableentries] }, "Lambda Bar Incl Data pT Extraction ", c3, c1);
	//LambdaBarMCCountincl = AnalyzeTree(new TFile(filelambdaTreeMC.c_str(), "read"), "Lambda Bar", 1, 0, LambdaBarMCxincl, { 10,bins[variableentries] }, "Lambda Bar Incl MC pT Extraction ", c3, c1);

	//KaonDataCountincl = AnalyzeTree(new TFile(filekaonTree.c_str(), "read"), "K0", 1, 1, KaonDataxincl, { 10,bins[variableentries] }, "Kaon Incl Data pT Extraction ", c3, c1);
	//KaonMCCountincl = AnalyzeTree(new TFile(filekaonTreeMC.c_str(), "read"), "K0", 1, 1, KaonMCxincl, { 10,bins[variableentries] }, "Kaon Incl MC pT Extraction ", c3, c1);
