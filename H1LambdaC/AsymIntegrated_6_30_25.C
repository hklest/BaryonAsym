...
void AsymIntegrated(int varidx, vector<double> q2bins, double DataIntLumi06, double MCDjangoh14radgen, double MCDjangoh14nonradgen, string filekaonTree, string filelambdaTree, string filekaonTreeMC, string filelambdaTreeMCRAPGAP, string filelambdaTreeMCDJANGOH, string filegenMCTreeRAPGAP, string filegenMCTreeDJANGOH, string fileNonRadgenMCTree, string fileRadgenMCTree, string xaxistitle, vector<vector<double>> binparaminitsLambda, vector<vector<double>> binrangedefsLambda, vector<vector<double>> binparaminitsLambdaBar, vector<vector<double>> binrangedefsLambdaBar, vector<vector<double>> binparaminitsMCLambda, vector<vector<double>> binrangedefsMCLambda, vector<vector<double>> binparaminitsMCLambdaBar, vector<vector<double>> binrangedefsMCLambdaBar) {
	...
	*/
	...
	LambdaRegMCRAPGAPCountincl = AnalyzeTreeMC(varidx, new TFile(filelambdaTreeMCRAPGAP.c_str(), "read"), "Lambda Reg Gen", 1, 0, LambdaRegMCRAPGAPxincl, { q2bins[0],q2bins[q2entries] }, "#Lambda RAPGAP Extraction", c3, c1, { {0.0016, 2.9,1.1156} }, { {1.088,1.098,1.137,1.16} });
	LambdaRegMCDJANGOHCountincl = AnalyzeTreeMC(varidx, new TFile(filelambdaTreeMCDJANGOH.c_str(), "read"), "Lambda Reg Gen", 1, 0, LambdaRegMCDJANGOHxincl, { q2bins[0],q2bins[q2entries] }, "#Lambda DJANGOH Extraction", c3, c1, { {0.00168, 2.5,1.1156} }, { {1.088,1.098,1.137,1.16} });
	...
	LambdaBarMCRAPGAPCountincl = AnalyzeTreeMC(varidx, new TFile(filelambdaTreeMCRAPGAP.c_str(), "read"), "Lambda Bar Gen", 1, 0, LambdaBarMCRAPGAPxincl, { q2bins[0],q2bins[q2entries] }, "#bar{#Lambda} RAPGAP Extraction", c3, c1, { {0.00168,2.5,1.1156} }, { {1.088,1.096,1.137,1.16} });
	LambdaBarMCDJANGOHCountincl = AnalyzeTreeMC(varidx, new TFile(filelambdaTreeMCDJANGOH.c_str(), "read"), "Lambda Bar Gen", 1, 0, LambdaBarMCDJANGOHxincl, { q2bins[0],q2bins[q2entries] }, "#bar{#Lambda} DJANGOH Extraction", c3, c1, { {0.00168,2.5,1.1156} }, { {1.088,1.096,1.137,1.16} });
