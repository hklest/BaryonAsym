...
string outputfilename = "/data/dust/group/h1/klesthen/BaryonAsym/H1LambdaC/DISControlPlotsTEST.root";
...
void DISControlPlots() {
	...
	cout << "Q2 done" << endl;
	Plot(outputfile, 0.1, 0.6, 100, 1, "y Distributions", "y Distributions", "y", "1/N dN/dy");
	cout << "Y done" << endl;
